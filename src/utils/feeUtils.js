...
//   // Money paid towards current term fees
//   const currentTermPaid = feeAccount.fees.reduce(
//     (sum, fee) => sum + Number(fee.paid || 0),
//     0
//   );

//   // Total paid = previous balance payments + current term payments
//   feeAccount.totalPaid =
//     currentTermPaid + Number(feeAccount.previousBalancePaid || 0);

//   // Outstanding balance
//   feeAccount.totalDue =
//     Number(feeAccount.netPayable || 0) -
//     Number(feeAccount.totalPaid || 0);
